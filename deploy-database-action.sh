...
export AZ_RESOURCE_GROUP=${{secrets.AZ_RESOURCE_GROUP}}
export AZ_DATABASE_NAME=${{secrets.AZ_DATABASE_NAME}}
export AZ_LOCATION=${{secrets.AZ_LOCATION}}
export AZ_SQL_SERVER_USERNAME=${{secrets.AZ_SQL_SERVER_USERNAME}}
export AZ_SQL_SERVER_PASSWORD=${{secrets.AZ_SQL_SERVER_PASSWORD}}
