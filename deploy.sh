...
az webapp create --resource-group $AZ_RESOURCE_GROUP --plan filmhub-backend-plan --name filmhub-backend --runtime "JAVA|21-java21"
...
#az webapp deploy --resource-group $AZ_RESOURCE_GROUP --name filmhub-backend --src-path target/filmhub-0.0.1-SNAPSHOT.jar --type jar

# Verificar el despliegue
#echo "Verificando el despliegue"
#echo "Abre tu navegador y navega a https://filmhub-backend.azurewebsites.net para verificar que tu aplicación esté funcionando"